...
const hide_fields_list = [
    "posting_time", "set_posting_time", "is_pos", "is_return", "is_debit_note", "due_date", "scan_barcode", "update_stock", 
    "taxes_section", "taxes", "total_taxes_and_charges", "selling_price_list", "ignore_pricing_rule"
];

const set_defaults = {
    "set_posting_time":1, "is_pos":0, "is_return":0, "is_debit_note":0, "update_stock":0
}
